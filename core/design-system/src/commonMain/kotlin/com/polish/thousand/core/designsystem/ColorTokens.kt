...
data class PolishThousandExtendedColors(
    ...
    val progressMiddle: Color,
    val progressEnd: Color,
    val milestoneWarmup: Color,
    val milestoneBase: Color,
    val milestoneConfidence: Color,
    val milestoneMomentum: Color,
    val milestoneMastery: Color,
...
internal val PolishThousandLightExtendedColors = PolishThousandExtendedColors(
    ...
    progressTrack = Color(0xFFE9E4DC),
    progressStart = Color(0xFF167F74),
    progressMiddle = Color(0xFF18AAA8),
    progressEnd = Color(0xFF3478C5),
    milestoneWarmup = Color(0xFF16897D),
    milestoneBase = Color(0xFF3478C5),
    milestoneConfidence = Color(0xFF8068C9),
    milestoneMomentum = Color(0xFFD27A43),
    milestoneMastery = Color(0xFFBF9728),
...
internal val PolishThousandDarkExtendedColors = PolishThousandExtendedColors(
    ...
    progressStart = Color(0xFF75D5C9),
    progressMiddle = Color(0xFF49C4D0),
    progressEnd = Color(0xFF7EA8FF),
    milestoneWarmup = Color(0xFF66CABB),
    milestoneBase = Color(0xFF81B7EE),
    milestoneConfidence = Color(0xFFB8A1EA),
    milestoneMomentum = Color(0xFFE5A574),
    milestoneMastery = Color(0xFFE7C662),
