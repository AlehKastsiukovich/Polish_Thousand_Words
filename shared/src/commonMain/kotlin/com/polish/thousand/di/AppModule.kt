...
import com.polish.thousand.payments.providePaymentClient
...
val appModule = module {
    ...
    single<PaymentClient> { providePaymentClient() }
    single { providePlatformAudioPlayer() }
    single<AppAudioPlayer> { AppAudioPlayerImpl(get(), get()) }
    viewModel { parameters -> AppViewModel(parameters.get(), get(), get()) }
