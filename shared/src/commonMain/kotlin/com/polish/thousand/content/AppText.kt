...
internal data class AppText(
    ...
    val settingsResetProgressDescription: String,
    val settingsResetProgressTitle: String,
    val settingsResetProgressMessage: String,
    val settingsResetProgressConfirm: String,
    val settingsResetProgressCancel: String,
...
private val ukrainianAppText = AppText(
    ...
    settingsBackupTitle = "Збереження прогресу",
    settingsBackupDescription = "Нічого налаштовувати в застосунку не потрібно. Після перевстановлення Android відновить прогрес, якщо ввімкнено резервне копіювання Google.",
    settingsVersion = "Версія",
    settingsResetProgress = "Скинути прогрес",
    settingsResetProgressDescription = "Почати шлях заново",
    settingsResetProgressTitle = "Скинути весь прогрес?",
    settingsResetProgressMessage = "Усі вивчені слова, уроки та повторення буде видалено. Цю дію не можна скасувати.",
    settingsResetProgressConfirm = "Скинути",
    settingsResetProgressCancel = "Скасувати",
    ...
    paywallSoftNote = "Без тиску. Можна повторювати вже відкриті слова й вирішити пізніше.",
    unlockFullCourse = "Відкрити повний курс",
    restorePurchases = "Відновити покупку",
    storeSetupRequired = "Покупки стануть доступні після налаштування App Store і Google Play.",
    paymentFailed = "Не вдалося завершити покупку. Спробуйте ще раз пізніше.",
    continueFree = "Продовжити безкоштовно",
    paywallFooter = "Не обов'язково вирішувати зараз. Безкоштовна частина й повторення залишаються доступними.",
...
private val russianAppText = AppText(
    ...
    settingsBackupTitle = "Сохранение прогресса",
    settingsBackupDescription = "Ничего настраивать в приложении не нужно. После переустановки Android восстановит прогресс, если включено резервное копирование Google.",
    settingsVersion = "Версия",
    settingsResetProgress = "Сбросить прогресс",
    settingsResetProgressDescription = "Начать путь заново",
    settingsResetProgressTitle = "Сбросить весь прогресс?",
    settingsResetProgressMessage = "Все изученные слова, уроки и повторения будут удалены. Это действие нельзя отменить.",
    settingsResetProgressConfirm = "Сбросить",
    settingsResetProgressCancel = "Отмена",
    ...
    paywallSoftNote = "Без давления. Можно повторять уже открытые слова и решить позже.",
    unlockFullCourse = "Открыть полный курс",
    restorePurchases = "Восстановить покупку",
    storeSetupRequired = "Покупки станут доступны после настройки App Store и Google Play.",
    paymentFailed = "Не удалось завершить покупку. Попробуйте позже.",
    continueFree = "Продолжить бесплатно",
    paywallFooter = "Не обязательно решать сейчас. Бесплатная часть и повторения остаются доступными.",
